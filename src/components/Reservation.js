...
const Reservation = () => {
  ...
  return (
    <section className="relative top-96 z-30 mb-20 lg:py-[100px]">
      <div className="container mx-auto">
        ...
        >
          ...
          >
            <img src={modelImg} alt="booking img" />
          </motion.div>
        </motion.div>
        {/* form  */}
        <motion.form
          ...
          whileInView={"show"}
        >
          <div className="flex flex-col lg:flex-row gapy-4 items-center justify-between mb-8">
            {/* datepicker  */}
            <div>
          ...
          {/* button  */}
          <div className="max-w-[316px] mx-auto mb-4 flex items-center justify-center">
